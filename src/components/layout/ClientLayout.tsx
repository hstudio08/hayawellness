  ...
  return (
    <>
      ...
      <a 
        ...
        className="fixed bottom-6 left-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all cursor-pointer flex items-center justify-center group"
      ...
      <a 
        href="tel:7889"
        className="fixed bottom-6 right-6 z-50 bg-emerald-teal text-white p-4 rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all cursor-pointer flex items-center justify-center group"
        aria-label="Call Urgent Help"
      >
