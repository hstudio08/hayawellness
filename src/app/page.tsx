        ...
        {!showAllInsta ? (
          <div className="mt-10 text-center">
            <button 
              ...
              className="bg-white text-emerald-deep px-8 py-3 rounded-full text-sm font-bold uppercase tracking-wider border-2 border-emerald-deep/10 hover:border-emerald-teal hover:bg-white transition-all shadow-sm hover:shadow-md cursor-pointer"
            >
              View More Reels
            </button>
          </div>
